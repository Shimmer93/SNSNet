...
python tools/merge_jbf.py --orig_pkl /scratch/PI/cqf/har_data/pkls/ntu120_hrnet.pkl --jbf_pkl /scratch/PI/cqf/har_data/pkls/ntu120_hrnet_tmp.pkl --out_pkl /scratch/PI/cqf/har_data/pkls/ntu120_hrnet_jbf.pkl
